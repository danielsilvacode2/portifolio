...
function mostrarErroCaptcha() {
   ...
   p.id = 'msg-ErroCaptcha'
   p.textContent = 'CONFIRME QUE VOCÊ NÃO É UM ROBO'
   erroCaptcha.appendChild(p)
   erroCaptcha.style.display = 'flex';
}

function esconderErroCaptcha() {
...
function validar(nome, email, estado, cidade) {
   ...
   if (email && !email.includes('@')) {
      marcarErro('email', 'EMAIL INVALIDO');
      valido = false;
   }
